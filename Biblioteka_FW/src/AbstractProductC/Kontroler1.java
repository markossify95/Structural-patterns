...
public final class Kontroler1 extends Kontroler {
    ...
    void Povezi() {
        ...
        javax.swing.JButton TekuciLog = ef.getPanel().getLog();
...
// Promenljivo!!!
    ...
    boolean zapamtiDomenskiObjekat() {
        ...
        prikaziPoruku();
        bbp.closeConnection();
        lg.dodajLog("zapamtiDomenskiObjekat", knjiga, poruka);
        return signal;
    ...
    boolean kreirajDomenskiObjekat() {
        ...
        prikaziPoruku();
        bbp.closeConnection();
        lg.dodajLog("kreirajDomenskiObjekat", knjiga, poruka);
        return signal;
    }
    ...
    boolean obrisiDomenskiObjekat() {
        ...
        lg.dodajLog("obrisiDomenskiObjekat", knjiga, poruka);
        return signal;
    }
    ...
    boolean promeniDomenskiObjekat() {
        ...
        lg.dodajLog("promeniDomenskiObjekat", knjiga, poruka);
        return signal;
    }
    ...
    boolean nadjiDomenskiObjekat() {
        ...
        prikaziPoruku();
        bbp.closeConnection();
        lg.dodajLog("nadjiDomenskiObjekat", knjiga, poruka);
        return signal;
    }
